// @generated by dabqlite-codegen from schema/records_v1.sql. DO NOT EDIT.
...
pub const RECORDS_SCHEMA_HASH: u64 = 0xC4345B300A440058;
...
pub fn encode_records_row(row: &RecordsRow, out: &mut [u8; RECORDS_ROW_SIZE]) {
    ...
    out[8..16].copy_from_slice(&row.value);
...
pub fn decode_records_row(bytes: &[u8]) -> Option<RecordsRow> {
    ...
    let value: [u8; 8] = bytes[8..16].try_into().ok()?;
